...
@Component
public class MisrBankIngestStrategy implements IngestionStrategy {

    @Override
    public SourceSystemCode supportedSource() {
        return SourceSystemCode.BANQUE_MISR_APP;
    }

    @Override
    public List<Transaction> ingest(String filePath, SourceSystem sourceSystem, CommandContext ctx) throws IOException {
        ctx.outputWriter().println("Banque Misr ingestion is not implemented yet.");
